...
@section('content')
    ...
    <form action="{{ url('/roles/' . $role->id) }}" method="post">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="name" class="form-control" placeholder="Enter a role name" value="{{ old('name', $role->name) }}">
            @if ($errors->has('name'))
        ...
        <div class="row border-bottom-dotted">
            ...
            <div class="col-md-9">
                <div class="form-check">
                    ...
                    {{ in_array($all_access_permission->id, $role_permissions) ? 'checked' : '' }}>
            ...
            <div class="col-md-9">
                @foreach ($user_feature_permissions as $user_feature_permission)
                    <div class="form-check mb-3">
                        ...
                        {{ in_array($user_feature_permission->id, $role_permissions) ? 'checked' : '' }}>
                        <label class="form-check-label">
            ...
            <div class="col-md-9">
                @foreach ($role_feature_permissions as $role_feature_permission)
                    <div class="form-check mb-3">
                        ...
                        {{ in_array($role_feature_permission->id, $role_permissions) ? 'checked' : '' }}>
                        <label class="form-check-label">
